...
product_dir = get_product_dir(protocol, satellite, sensor, product_level, product, sector)
...
time = find_closest_start_time(time = datetime.datetime(2021,8,11,11,25),
                               base_dir=base_dir,
                               protocol=protocol,
                               fs_args=fs_args,
                               satellite=satellite, 
...
latest_time = find_latest_start_time(base_dir=base_dir,
                                     protocol=protocol,
                                     fs_args=fs_args,
                                     satellite=satellite, 
                                     sensor=sensor, 
...
fpath_dict = find_previous_files(start_time=start_time, 
                                 N = N,
                                 satellite=satellite, 
                                 sensor=sensor, 
                                 product_level=product_level, 
                                 ...
                                 check_consistency=True)
fpath_dict.keys()      
fpath_dict = find_next_files(start_time=start_time, 
                             N = N,
                             satellite=satellite, 
                             sensor=sensor, 
                             product_level=product_level, 
